<html>
    <head>
        ...
        <script src="https://kit.fontawesome.com/f23c51b85b.js" crossorigin="anonymous"></script>
        <link href="https://fonts.googleapis.com/css?family=Raleway&display=swap" rel="stylesheet">
        <link rel="stylesheet" href="/certme/static/css/main.css"/>
    </head>
    <body>
        <header id="header">
            <div class="container-fluid">
            <div class="row ">
                <div class="col-md-2 info p-3" >
                    <p class="">+1 (647) 763-9826</p>
                </div>
                <div class="col-md-8 main-logo p-3">
                    <img src="/certme/static/imgs/logo.png" width="120px"/>
                </div>
                <div class="col-md-2 social p-3">
